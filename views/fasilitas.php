    ...
    <div class="roberto-rooms-area section-padding-100-0">
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-8">
                    ...
                    <div class="room-service mb-50">
                        ...
                        $fs = $obj->dataFasilitas();
                        // looping data gedung 
                        foreach($fs as $f){
                        ?>
                            <li>
                                <img src="img/core-img/icon<?= $f['id'] ?>.png" alt=""><?= $f['nama'] ?>
                               <form action="fasilitasController.php" method="post">
                               <?php 
                                if(isset($user)){
                                    if ($role != 'peminjam') {
                                ?>
                               <a href="index.php?hal=fasilitas_form_edit&id=<?= $f['id'] ?>"  class="btn btn-warning mx-2">
                                <i class="fa fa-edit"></i></a>
                                <?php 
                                if ($role != 'staff') {
                                ?>
                                <button class="btn btn-danger fa fa-trash" type="submit" name="tombol" value="hapus" onclick="confirm('Anda Yakin Ingin Menghapus?')"></button>
            ...
            <?php }} ?>
                    ...
                    <!-- Room Review -->
                    <div class="room-review-area mb-100 mt-50">
                        <h4>Room Review</h4>
