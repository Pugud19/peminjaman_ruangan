                        ...
                        <div class="row h-100 align-items-center">
                            ...
                            <div class="col-12">
                                <div class="welcome-text text-center">
                                    <h6 data-animation="fadeInLeft" data-delay="200ms">Rent Room</h6>
                                    <h2 data-animation="fadeInLeft" data-delay="500ms">Welcome To Peminjaman Ruangan Apps</h2>
                ...
                <div class="welcome-content h-100">
                    <div class="container h-100">
                        <div class="row h-100 align-items-center">
                            ...
                            <div class="col-12">
                                <div class="welcome-text text-center">
                                    <h6 data-animation="fadeInUp" data-delay="200ms">Rent Room</h6>
                                    <h2 data-animation="fadeInUp" data-delay="500ms">Welcome To Peminjaman Ruangan Apps</h2>
                ...
                <div class="welcome-content h-100">
                    <div class="container h-100">
                        <div class="row h-100 align-items-center">
                            ...
                            <div class="col-12">
                                <div class="welcome-text text-center">
                                    <h6 data-animation="fadeInDown" data-delay="200ms">Rent Room</h6>
                                    <h2 data-animation="fadeInDown" data-delay="500ms">Welcome To Peminjaman Ruangan Apps</h2>
